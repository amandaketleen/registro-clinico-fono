...
/* === GERAR NOVO ID DE PACIENTE === */

function gerarNovoId() {

  const pacientesBase = [1, 2, 3, 4, 5, 6, 7]
  ...
  const maiorId = todosIds.length > 0
    ? Math.max(...todosIds)
    : 0
...
/* === FORMULÁRIO - CADASTRAR NOVO PACIENTE === */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', function (e) {
    ...
    const atendimento =
      document.querySelector('#atendimento').value
